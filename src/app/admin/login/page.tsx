        ...
        <form action={login} className="grid gap-4">
          <div>
            ...
            <input id="pw" name="password" type="password" required autoFocus
              className="w-full px-3.5 py-3 rounded border border-line bg-paper text-ink text-sm focus:outline-none focus:border-accent-dark" />
          </div>
          <button type="submit" className="bg-ink text-white py-3 rounded font-semibold text-sm hover:bg-accent-dark transition">
            Se connecter
          </button>
        </form>
      </div>
