...
export const projects: Project[] = [
  {
    ...
    photos: [
      ...
      { src: '/photos/realisation-bw/extension-bois-soubassement-pierre-brabant-wallon.jpg', alt: 'Extension bois et soubassement en pierre, réalisation François Kerremans' },
    ],
  },
  {
    slug: 'avant-apres',
    ...
    photos: [
      ...
      { src: '/photos/avant-apres/renovation-maison-brabant-wallon-avant.jpg', alt: 'Maison avant rénovation par François Kerremans' },
      { src: '/photos/avant-apres/renovation-maison-brabant-wallon-apres.jpg', alt: 'Maison après rénovation par François Kerremans, Brabant wallon' },
    ],
  },
  {
    slug: 'elegant-bw',
    ...
    photos: [
      ...
      { src: '/photos/elegant-bw/extension-bois-detail-bardage-02.jpg', alt: 'Détail bardage bois extension, François Kerremans' },
      { src: '/photos/elegant-bw/extension-bois-jardin-03.jpg', alt: "Vue de l'extension bois depuis le jardin, Brabant wallon" },
      { src: '/photos/elegant-bw/extension-bois-ensemble-04.jpg', alt: "Extension bois vue d'ensemble, François Kerremans Chastre" },
    ],
  },
  {
    slug: 'cabane-bomal',
  ...
  },
  {
    ...
    photos: [
      ...
      { src: '/photos/paille-tech/construction-paille-detail-05.jpg', alt: 'Détail ossature paille, François Kerremans' },
  ...
  },
  {
    ...
    photos: [
      ...
      { src: '/photos/permis-urbanisme-soignies/permis-urbanisme-soignies-detail-04.jpg', alt: "Détail projet architecte Soignies, François Kerremans" },
      ...
      { src: '/photos/permis-urbanisme-soignies/permis-urbanisme-soignies-vue-arriere-06.jpg', alt: "Vue arrière maison Soignies, François Kerremans" },
    ],
  },
]
